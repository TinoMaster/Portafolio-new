...
export const PagInicio = () => {
  return (
    <section className="w-full flex flex-col relative pt-20">
      <HeroHome />
      <section className="w-full bg-gradient-to-r from-darkMode via-primary/5 relative lg:via-primary/5 to-darkMode pb-5">
        <div className="gradient"></div>
        <Section Component={SectionBlog} />
      </section>
      <section className="w-full bg-gradient-to-b from-zinc-800 via-white/5 to-zinc-800">
