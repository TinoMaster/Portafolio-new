   ...
   return (
      <div className="flex w-full justify-center items-center rounded-md relative select-none">
         ...
         >
            ...
            <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-md bg-[#0a0f0e]/90 px-4 py-2.5 text-sm font-medium text-white backdrop-blur-3xl">
               {t('hero.cv')}
            </span>
         </div>
         <AnimatePresence>
